...
function compareBlocksAcrossPlatforms(platformBlocks, startBlock, endBlock) {
  ...
  for (const [blockNum, platforms] of Object.entries(blockCoverage)) {
  ...
  const commonBlocks = Object.entries(blockCoverage)
    .filter(([_, platforms]) => platforms.length === platforms.length)
...
// Execute the analysis for blocks 46000-47000
// This range should have blocks in all platforms including Subsquid
